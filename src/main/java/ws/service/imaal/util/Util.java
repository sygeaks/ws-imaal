...
public class Util {
  ...
  public static String getDiretorioPasta(String diretorioRaiz, String dataGeracao) {

    // Trata pastas de acordo com a data de geracao: Formato String
    // "2021-02-15T03:00:00.000Z"
    String anoMTR = dataGeracao.substring(0, 4);
    String mesMTR = dataGeracao.substring(5, 7);
    ...
    String diretorioArquivo = diretorioRaiz + anoMTR + "//" + mesMTR + "//";

    return diretorioArquivo;
  }

  public static String getDataAtual(String dateFormat) {
